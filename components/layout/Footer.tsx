                        ...
                        <div className="mt-4 flex gap-4">
                            ...
                            >
                                <svg width="18" height="18" viewBox="0 0 448 512" fill="currentColor">
                                    <path d="M448 209.91a210.06 210.06 0 0 1 -122.77-39.25v178.72A162.55 162.55 0 1 1 162.6 162.55V274.52a50.55 50.55 0 1 0 50.55 50.55V0h111.45a162.55 162.55 0 0 0 123.37 131.64h.02V209.91z" />
                                </svg>
                            </a>
                            ...
                            {!settings?.instagramUrl && !settings?.tiktokUrl && (
                                <>
                                    ...
                                    <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-authentic-linen/10 text-authentic-linen/60 transition-colors hover:bg-terracotta-earth hover:text-white" aria-label="TikTok">
                                        <svg width="18" height="18" viewBox="0 0 448 512" fill="currentColor"><path d="M448 209.91a210.06 210.06 0 0 1 -122.77-39.25v178.72A162.55 162.55 0 1 1 162.6 162.55V274.52a50.55 50.55 0 1 0 50.55 50.55V0h111.45a162.55 162.55 0 0 0 123.37 131.64h.02V209.91z" /></svg>
                                    </a>
                                </>
                            )}
                        </div>

                        <h4 className="mt-8 font-heading text-lg font-semibold text-authentic-linen">
                            Beli di Marketplace
                        </h4>
